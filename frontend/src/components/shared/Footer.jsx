      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">Developed By BALDEV SINGH</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/baldav.singh.9/" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://twitter.com/BALDEVS25188315" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/baldev-singh-rathore-472096115/" className="hover:text-gray-400" aria-label="LinkedIn">
